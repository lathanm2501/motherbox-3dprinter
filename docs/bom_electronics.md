# Electronics BOM — 310x310 Bed Slinger 3D Printer
...
| Raspberry Pi Pico (RP2040) | 1 | Secondary MCU — dual ADXL345 via UART to Pi |
...
| Buck converter — XY-3606 | 1 | 24V → 5.2V 6A, powers Pi 3+ and Pico via VSYS |
...
| Y-axis upgrade motor | TBD | Target 0.55–0.65N.m, 48mm body — e.g. LDO-42STH48-2004AC or equivalent |
...
| Touchscreen display | 1 | 5" IPS DSI, 800×480, capacitive touch, MIPI DSI, driver-free, Pi 3B+ compatible — running KlipperScreen |
